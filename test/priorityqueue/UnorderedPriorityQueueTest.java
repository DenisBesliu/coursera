 ...
 * @created 4/4/13
 */
public class UnorderedPriorityQueueTest {

    private UnorderedPriorityQueue priorityQueue;


    @Before
    public void setUp() throws Exception {
        priorityQueue = new UnorderedPriorityQueue(10);
    ...
    public void insertIntoZeroLengthQueue() {
        UnorderedPriorityQueue queue = new UnorderedPriorityQueue(0);
